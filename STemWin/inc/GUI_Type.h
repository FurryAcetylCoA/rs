...
typedef struct {
  ...
  //
  // 16 Bit access   //ILI9341 дкет
  //
  void (* pfWrite16_A0) (U16 Data);  //needed
  void (* pfWrite16_A1) (U16 Data);  //needed
  void (* pfWriteM16_A0)(U16 * pData, int NumItems);
  void (* pfWriteM16_A1)(U16 * pData, int NumItems); //needed
  U16  (* pfRead16_A0)  (void);
  U16  (* pfRead16_A1)  (void);
  void (* pfReadM16_A0) (U16 * pData, int NumItems);
  void (* pfReadM16_A1) (U16 * pData, int NumItems); //needed
  //
  // 32 Bit access
  //
